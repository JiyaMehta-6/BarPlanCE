...
if __name__ == '__main__':
    ...
    cut_len_req_list_i = cut_len_req_list
    ...
    while len(cut_len_req_list_i):
        ...
        cut_recomonded = all_possible_combi_sort_df_i.iloc[0][:-1]
        ...
        if match_found:
            print( 'Bar present')
            cut_schedule.append(list(cut_recomonded))
            cut_schedule.append(list(cut_recomonded))
        else:
            print( 'Bar abseny')
        ...
        print(cut_schedule)
        # cut_len_req_list_i.pop(0)
        # all_possible_combi_sort_df_i.drop(index=0, inplace=True)
